...
class MotorcycleParkingSlotsPage extends StatelessWidget {
  final String areaName; // Pass the selected area name to this page

  const MotorcycleParkingSlotsPage({super.key, required this.areaName});
    ...
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          // Extract slot keys dynamically
          final slotKeys = data.keys.toList()
            ..sort((a, b) => a.compareTo(b)); // Sort slots for consistency
                  ...
                  GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        ...
                        color: isOccupied
                            ? Colors.red[900]
                            : Colors.green[600], // Blue for available slots
